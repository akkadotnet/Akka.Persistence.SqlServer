//-----------------------------------------------------------------------
// <copyright file="BatchingSqlServerAllPersistenceIdsSpec.cs" company="Akka.NET Project">
...
namespace Akka.Persistence.SqlServer.Tests.Batching
{
    ...
    public class BatchingSqlServerAllPersistenceIdsSpec : AllPersistenceIdsSpec
    {
        ...
        public BatchingSqlServerAllPersistenceIdsSpec(ITestOutputHelper output) : base(Config, output)
        {
            DbUtils.Initialize();
        }
